...
class UIControl(metaclass=ABCMeta):
    ...
    def get_invalidate_events(self) -> List['Event']:
        """
...
class FormattedTextControl(UIControl):
    ...
    def __init__(
        ...
        self._fragments: Optional[StyleAndTextTuplesWithMouseHandlers] = None
    ...
    def _get_formatted_text_cached(self) -> StyleAndTextTuplesWithMouseHandlers:
        """
    ...
    def create_content(self, width: int, height: Optional[int]) -> UIContent:
        ...
        def get_cursor_position(fragment='[SetCursorPosition]') -> Optional[Point]:
...
class BufferControl(UIControl):
    ...
    def __init__(
            ...
            search_buffer_control: Union[None, 'SearchBufferControl', Callable[[], 'SearchBufferControl']] = None,
    ...
    def _create_get_processed_line_func(
            self, document: Document, width: int, height: Optional[int]):
        """
    ...
    def create_content(self, width: int, height: Optional[int],
