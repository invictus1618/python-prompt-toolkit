...
class _Split(Container):
    ...
    """
    def __init__(self, children: List[AnyContainer],
...
class Window(Container):
    ...
    def __init__(
            ...
            left_margins: Optional[List[Margin]] = None,
            ...
            get_line_prefix: Optional[Callable[[int, int], AnyFormattedText]] = None) -> None:
    ...
    def _scroll_without_linewrapping(self, ui_content: UIContent,
        ...
        def do_scroll(current_scroll: int, scroll_offset_start: int,
                      ...
                      window_size: int, content_size: int):
