...
class DummyCompleter(Completer):
    ...
    """
    def get_completions(
            self, document, complete_event: CompleteEvent) -> Iterable[Completion]:
        return []
...
class DynamicCompleter(Completer):
    ...
    """
    def __init__(self, get_completer: Callable[[], Completer]) -> None:
...
def merge_completers(completers: List[Completer]) -> _MergedCompleter:
    """
    Combine several completers into one.
    """
...
def get_common_complete_suffix(
        document, completions: List[Completion]) -> str:
    """
